...
(defun cabins/font-setup ()
  ...
  (when (display-graphic-p)
    ;; Default font
    (cl-loop for font in '("Fira Code" "Jetbrains Mono" "Courier Prime" "Cascadia Code"  "Hack" "Source Code Pro" "Menlo" "Monaco" "Consolas")
...
;;          (dark-theme (cabins/available-theme '(nord dracula modus-vivendi leuven-dark tsdh-dark tango-dark wombat dichromacy))))
